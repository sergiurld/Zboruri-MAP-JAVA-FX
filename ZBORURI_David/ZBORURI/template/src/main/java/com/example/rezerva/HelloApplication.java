...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        this.service = new Service(new ClientRepo("jdbc:postgresql://localhost:5432/zboruri","postgres","Barcelona"),
                new FlightRepo("jdbc:postgresql://localhost:5432/zboruri","postgres","Barcelona"),
                new TicketRepo("jdbc:postgresql://localhost:5432/zboruri","postgres","Barcelona"));
